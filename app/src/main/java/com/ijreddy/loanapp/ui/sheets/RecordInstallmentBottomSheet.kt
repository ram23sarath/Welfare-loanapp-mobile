...
/**
 * Bottom sheet for recording an installment payment.
 * Replaces RecordInstallmentModal from web.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun RecordInstallmentBottomSheet(
    loanId: String,
    customerName: String,
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Text(
                text = "Record Installment #$installmentNumber",
